...
const fitsCharLength = val => val.length <= 30 || "Must be 30 characters or less";
...
const createEmployee = async (isManager) => {
    ...
    if (isManager) {
        ...
        await readAllEmployees();
        console.log(chalk.green(`Inserted Employee: ${answers.first_name} ${answers.last_name}`));
    }
};
...
const updateEmployee = async (isManager) => {
    ...
    if (isManager) {
        ...
        await readAllEmployees();
        console.log(chalk.green(`Updated employee: ${answers.first_name} ${answers.last_name}`))
    }
